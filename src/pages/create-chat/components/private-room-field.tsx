...
const PrivateRoomField = (props: {isPrivate: boolean, setIsPrivate: React.Dispatch<React.SetStateAction<boolean>>, 
	...
	return (
		<div>
			...
			<div className="flex">
				...
				<input type="text" onChange={onChangePassword} value={password} disabled={!isPrivate}>
				</input>
			</div>
		</div>
	);
